...
@register_model
class OneClassSVMPlugin(ModelPlugin):
    model_type = "one_class_svm"
    capabilities = {
        "trajectory_scores": True,
        "transition_scores": True,
        "feature_explanations": False,
        "explanation_type": "decision_function_distance",
    }
    ...
    def train(self, feature_root, model_dir):
        ...
        kernel = architecture.get("kernel", "rbf")
        nu = architecture.get("nu", 0.05)
        gamma = architecture.get("gamma", "scale")
        max_train_samples = architecture.get("max_train_samples", 10_000)
        ...
        for dataset_name in datasets:
            ...
            try:
                ...
                def flush_batch():
                    ...
                    scores_batch = -model.decision_function(X_batch)
