...
let modelConfigurationDirty = false;
let thresholdConfigurationDirty = false;
...
let leafletMap = null;
let currentMarkers = [];
let trajectoryBubbleLayer = null;
let latestBubbleRequestKey = '';
let selectedTrajectoryIds = new Set();
let selectedTrajectoryLayers = new Map();
let hiddenSelectedTrajectoryIds = new Set();
let selectedTrajectoryTimelineItems = new Map();
let appliedTrajectoryScoreFilter = null;
let scoreDistributionPayload = null;
let scoreDistributionSettingsKey = '';
let scoreRangeSelection = null;
let expandedBubbleLayers = [];
let latestScoreDistributionRequestKey = '';
let scoreDistributionTimer = null;
